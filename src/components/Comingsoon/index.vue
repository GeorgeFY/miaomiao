...
export default {
  ...
  mounted() {
  	this.axios.get("/ajax/comingList?ci=57&token=&limit=10&optimus_uuid=3BD00ED02B9311EB83CBCBE2BA8F0E0C6093BDE586664C92BC95CB0254E22EC9&optimus_risk_level=71&optimus_code=10").then((res)=>{
